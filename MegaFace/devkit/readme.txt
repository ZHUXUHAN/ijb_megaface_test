...
1.3 Usage
    run_experiment.py - <megaface_features_path> <probe_features_path> <out_root> optional: -d -s <sizes> -m <model> -ns <number of sets to run> -si <indices of sets to run>
        megaface_features_path - Path to root directory of megaface features
        probe_feature_list - Path to root directory of facescrub(probe) features
...
3.4 Process Overview
    1. Produce features for megaface and facescrub datasets
