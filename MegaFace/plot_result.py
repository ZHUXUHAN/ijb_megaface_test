...
if __name__ == '__main__':
    sample='celeb360k_final1.0'
    your_method_dirs = [
        '/train/trainset/1/face/megaface_test/result_clean/{}_results'.format(str(sample)),
    ]
    your_method_labels = [
    ...
    for probe_name in probesets:
        save_dir = '/train/trainset/1/face/megaface_test/cmc_roc_results/{}'.format(str(sample))
